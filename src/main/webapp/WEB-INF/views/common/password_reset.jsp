        ...
        <div class="modal-content">
            <div class="modal-header bg-secondary">
                <ul class="nav nav-tabs card-header-tabs" role="tablist">
                    <li class="nav-item"><a class="nav-link fw-medium active" href="${pageContext.request.contextPath}/resources/dist/#signin-tab" data-bs-toggle="tab" role="tab" aria-selected="true"><i class="ci-unlocked me-2 mt-n1"></i>회원가입</a></li>
            ...
            <div class="modal-body tab-content py-4">
                ...
                <form class="needs-validation tab-pane fade" autocomplete="off" novalidate id="signup-tab">
                    ...
                    <button class="btn btn-primary btn-shadow d-block w-100" type="submit">회원가입</button>
                </form>
            </div>
        </div>
    </div>
