...
<main class="page-wrapper">
    ...
    <header class="navbar d-block navbar-sticky navbar-expand-lg navbar-light bg-light">
        <div class="container"><a class="navbar-brand d-none d-sm-block me-4 order-lg-1" href="index.html"><img src="img/logo-dark.png" width="142" alt="Cartzilla"></a><a class="navbar-brand d-sm-none me-2 order-lg-1" href="index.html"><img src="img/logo-icon.png" width="74" alt="Cartzilla"></a>
            <div class="navbar-toolbar d-flex align-items-center order-lg-3">
                ...
                <div class="navbar-tool-icon-box"><i class="navbar-tool-icon ci-search"></i></div></a><a class="navbar-tool ms-2" href="#" data-bs-toggle="modal"><span class="navbar-tool-tooltip">Account</span>
            ...
            <div class="collapse navbar-collapse me-auto order-lg-2" id="navbarCollapse">
                ...
                <ul class="navbar-nav navbar-mega-nav ms-lg-4 pe-lg-2 me-lg-2">
                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle ps-lg-0" href="#" data-bs-toggle="dropdown">일러스트</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#">인기 카테고리</a></li>
        ...
        <div class="container pb-5">
            <div class="row justify-content-center pb-5">
                <div class="col-xl-6 col-lg-7 col-md-8 col-sm-10 text-center">
                    ...
                    </div><a class="btn btn-primary" href="#cuisine" data-scroll>요금제 및 가격 보기</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="container py-4 my-lg-3 py-sm-5" id="cuisine">
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 mb-grid-gutter"><a class="card border-0 shadow" href="food-delivery-category.html"><img class="card-img-top" src="img/istock/템플릿.PNG" alt="Burgers &amp; Fries">
                <div class="card-body py-4 text-center">
                    <h3 class="h5 mt-1">템플릿</h3>
                </div></a></div>
            <div class="col-md-4 col-sm-6 mb-grid-gutter"><a class="card border-0 shadow" href="food-delivery-category.html"><img class="card-img-top" src="img/istock/%EC%95%84%EC%9D%B4%EC%BD%98.PNG" alt="Noodles">
                <div class="card-body py-4 text-center">
                    <h3 class="h5 mt-1">아이콘</h3>
                </div></a></div>
            <div class="col-md-4 col-sm-6 mb-grid-gutter"><a class="card border-0 shadow" href="food-delivery-category.html"><img class="card-img-top" src="img/istock/%EB%B0%B0%EA%B2%BD.PNG" alt="Sushi &amp; Rolls">
                <div class="card-body py-4 text-center">
                    <h3 class="h5 mt-1">배경</h3>
                </div></a></div>
            <div class="col-md-4 col-sm-6 mb-grid-gutter"><a class="card border-0 shadow" href="food-delivery-category.html"><img class="card-img-top" src="img/istock/%ED%8A%B9%EB%B3%84%ED%96%89%EC%82%AC.PNG" alt="Pizza &amp; Pasta">
                <div class="card-body py-4 text-center">
                    <h3 class="h5 mt-1">특별 행사</h3>
                </div></a></div>
            <div class="col-md-4 col-sm-6 mb-grid-gutter"><a class="card border-0 shadow" href="food-delivery-category.html"><img class="card-img-top" src="img/istock/%EC%9E%90%EC%97%B0%EB%B0%8F%ED%92%8D%EA%B2%BD.PNG" alt="Coffee &amp; Desserts">
                <div class="card-body py-4 text-center">
                    <h3 class="h5 mt-1">자연 및 풍경</h3>
                </div></a></div>
            <div class="col-md-4 col-sm-6 mb-grid-gutter"><a class="card border-0 shadow" href="food-delivery-category.html"><img class="card-img-top" src="img/istock/%EC%95%A0%EC%99%84%EB%8F%99%EB%AC%BC%EB%B0%8F%EB%8F%99%EB%AC%BC.PNG" alt="Healthy &amp; Food">
                <div class="card-body py-4 text-center">
...
<footer class="footer bg-darker pt-5">
    <div class="container pt-2">
        ...
        <div class="d-md-flex justify-content-between pt-4 pb-1">
            <div class="pb-4 fs-xs text-light opacity-50 text-center text-md-start">© All rights reserved. Made by <a class="text-light" href="https://createx.studio/" target="_blank" rel="noopener">hanmin oh</a></div>
